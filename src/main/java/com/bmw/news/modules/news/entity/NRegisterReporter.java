 ...
 * @version 2018-12-02
 */
public class NRegisterReporter extends DataEntity<NRegisterReporter> {
	...
	private String reporterIsAccess;		// 是否通过认证0未认证1认证
	private Date reporterAccessTime;		// 通过认证时间
	private Date reporterRegistryTime;		// 注册时间
	private Date reporterLastLoginTime;		// 最后登陆时间
	...
	private Date reporterAuditTime;		// 审核时间
	private String reporterAuditUserId;		// 审核结果0未审核1审核通过2审核不通过
	private String reporterAuditUserName;		// 审核结果0未审核1审核通过2审核不通过
	private String reporterAuditResult;		// 审核结果0未审核1审核通过2审核不通过
	...
	private String reporterWorkCert;		// 工作证明
	...
	private String reporterIsHaveChild;		// 是否有孩子0无1有
	...
	private String reporterPhoneFlag;		// 记者手机号是否一致0不一致1一致
	
	public NRegisterReporter() {
		super();
	}

	public NRegisterReporter(String id){
		super(id);
	}
	...
	@Length(min=0, max=1, message="是否通过认证0未认证1认证长度必须介于 0 和 1 之间")
	public String getReporterIsAccess() {
		return reporterIsAccess;
	}

	public void setReporterIsAccess(String reporterIsAccess) {
		this.reporterIsAccess = reporterIsAccess;
	}
	
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	public Date getReporterAccessTime() {
		return reporterAccessTime;
	}

	public void setReporterAccessTime(Date reporterAccessTime) {
		this.reporterAccessTime = reporterAccessTime;
	}
	
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	public Date getReporterRegistryTime() {
		return reporterRegistryTime;
	}

	public void setReporterRegistryTime(Date reporterRegistryTime) {
		this.reporterRegistryTime = reporterRegistryTime;
	}
	
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	public Date getReporterLastLoginTime() {
		return reporterLastLoginTime;
	}

	public void setReporterLastLoginTime(Date reporterLastLoginTime) {
		this.reporterLastLoginTime = reporterLastLoginTime;
	}
	...
	@JsonFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	public Date getReporterAuditTime() {
		return reporterAuditTime;
	}

	public void setReporterAuditTime(Date reporterAuditTime) {
		this.reporterAuditTime = reporterAuditTime;
	}
	
	@Length(min=0, max=40, message="审核结果0未审核1审核通过2审核不通过长度必须介于 0 和 40 之间")
	public String getReporterAuditUserId() {
		return reporterAuditUserId;
	}

	public void setReporterAuditUserId(String reporterAuditUserId) {
		this.reporterAuditUserId = reporterAuditUserId;
	}
	
	@Length(min=0, max=40, message="审核结果0未审核1审核通过2审核不通过长度必须介于 0 和 40 之间")
	public String getReporterAuditUserName() {
		return reporterAuditUserName;
	}

	public void setReporterAuditUserName(String reporterAuditUserName) {
		this.reporterAuditUserName = reporterAuditUserName;
	}
	
	@Length(min=0, max=1, message="审核结果0未审核1审核通过2审核不通过长度必须介于 0 和 1 之间")
	public String getReporterAuditResult() {
		return reporterAuditResult;
	}

	public void setReporterAuditResult(String reporterAuditResult) {
		this.reporterAuditResult = reporterAuditResult;
	}
	...
	@Length(min=0, max=255, message="工作证明长度必须介于 0 和 255 之间")
	public String getReporterWorkCert() {
		return reporterWorkCert;
	}

	public void setReporterWorkCert(String reporterWorkCert) {
		this.reporterWorkCert = reporterWorkCert;
	}
	...
	@Length(min=0, max=1, message="是否有孩子0无1有长度必须介于 0 和 1 之间")
	...
	@Length(min=0, max=1, message="记者手机号是否一致0不一致1一致长度必须介于 0 和 1 之间")
	public String getReporterPhoneFlag() {
		return reporterPhoneFlag;
	}

	public void setReporterPhoneFlag(String reporterPhoneFlag) {
		this.reporterPhoneFlag = reporterPhoneFlag;
	}
