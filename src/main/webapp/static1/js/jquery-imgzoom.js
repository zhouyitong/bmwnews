(function ($) {
    $.fn.imgZoom = function () {
        var mask =
            "<div style = 'position: absolute;width: 100%;z-index: 5555;height: 100%;top: 0;left: 0;background: rgba(0,0,0,0.5);display:none;' id='imgZoomMask'><a style='display:block;position:absolute;top:15px;right:15px;font-size:30px;color:#fff;cursor:pointer'>X</a></div>";
        $("html").append(mask);
